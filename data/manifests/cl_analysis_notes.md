...
```json
{
  ...
  "daily_table": "data/processed/cl_daily_research_table.parquet",
  "regression_specs": {
    "eq5_onfh": [
      "r_ONFH"
    ],
  ...
  "samples": {
    "replication": {
      ...
      "end": "2020-05-01",
      "nobs": 2345,
      "common_valid_nobs": 2345
    },
    "oos": {
      "start": "2021-01-05",
      "end": "2025-12-31",
      "nobs": 1213,
      "common_valid_nobs": 1213
    }
  },
  "outputs": {
    ...
    "notes": "data/manifests/cl_analysis_notes.md"
  }
}
```
